...
@Composable
fun CommunityBtn(onCommunityBtnTapped: () -> Unit, modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.community),
        contentScale = ContentScale.Crop,
        modifier = modifier
            .tappable(onTap = onCommunityBtnTapped)
